...
function renderStandings(teams, matches) 
{
    ...
    standings.forEach((t, i) => 
    {
        ...
        // --- ASIGNACIÓN DE CLASES PARA PLAYOFFS Y PLAYIN ---
        let positionClass = "";
        if (i >= 0 && i <= 3) {
            positionClass = "pos-direct"; // Del 1 al 4
        } else if (i >= 4 && i <= 11) {
            positionClass = "pos-playin"; // Del 5 al 12
        }

        const row = `
            <tr>
                <td><div class="cell-pos-box ${positionClass}">${i + 1}</div></td>
                <td class="t-left">
                    <div class="team-cell">
